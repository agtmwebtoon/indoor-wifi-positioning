...
### Admin measurement app

Use the spinner to select the number of floors and lakes and press the START button to find the RSSI value of nearby Wi-Fi and inform the WAP and distance.
